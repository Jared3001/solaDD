// AUTO-GENERATED by web/hud_rents/build_hud_rents.py — do not edit by hand.
// California Tax Credit Allocation Committee (CTCAC) 2025 Maximum MTSP Rents for LIHTC Projects
...
window.HUD_RENTS = {
  "_meta": {
    ...
    "sourceUrl": "https://www.treasurer.ca.gov/sites/default/files/2025-10/rent_040125.pdf",
    "tiers": "Official CTCAC tiers 20-100%; 110% is derived = 100% x 1.10 (ami110Approx).",
    "grossVsNet": "GROSS caps (include utility allowance). The proforma applies its Utility Allowance input to net them down.",
    "basis": "MTSP / LIHTC. NOT market rent, and differs from city CRL/SB341 or HCD 'Moderate' caps \u2014 use only for tax-credit/affordable underwriting.",
  ...
  "counties": {
    ...
    "06075": {
      ...
      "ami110Note": "A real 110% rent exists via SF MOHCD inclusionary/BMR on a DIFFERENT methodology (occupancy BR+1, MOHCD AMI hold-harmless) than the CTCAC basis used here. Switch to MOHCD figures only for MOHCD BMR deals."
    },
    "06077": {
